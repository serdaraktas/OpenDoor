...
public class MainActivity extends AppCompatActivity {
    ...
    private void openDoor() {
        ...
        new Thread(() -> {
            try {
                ...
                HttpResult loginResult = httpPost("http://" + host + "/csl/login", loginBody, null);
                ...
                HttpResult doorResult = httpPost("http://" + host + "/form/Device?act=22", doorBody, cookie);
    ...
    private HttpResult httpPost(String urlStr, String body, String cookie) throws Exception {
    ...
    static class HttpResult {
        int status; List<String> cookies;
